      ...
      <SafeAreaView style={{alignItems: 'center', width: 460, }}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity onPress={() => props.navigation.navigate("ResetPw")}>
          ...
          <Button textColor='white' bgColor={purple} btnLabel="Login as student" Press={handleLoginStudent} />
          <Button textColor='white' bgColor={purple} btnLabel="Login as teacher" Press={handleLoginTeacher} />
          <View style={{ display: 'flex', flexDirection :'row', justifyContent: "center" }}>
            <Text style={{ fontSize: 16, fontWeight:"bold" }}>Don't have an account ? </Text>
            <TouchableOpacity onPress={() => props.navigation.navigate("Signup")}>
            <Text style={{ color: purple, fontWeight: 'bold', fontSize: 16 }}>Signup</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
